...
var energyLevelsBaverage = []float64{270, 240, 210, 180, 150, 120, 90, 60, 30, 0}
...
func (fb FibreGram) GetPoints(st ScoreType) int {
	return getPointsFromRange(float64(fb), fibreLevels)
}
